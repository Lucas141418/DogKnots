    ...
    const units = /*html*/ `
            <div class="section-filters">
                ...
                <span class="filter-options">
                    ...
                    <input id="search-for-name" class="search-bar" placeholder="Tibás" type="text">
                </span>
                ...
                <span class="filter-options">
                    ...
                    <select id="search-for-canton"><option value=""></option></select>
                </span>
...
const tableData = [
  {
    ...
    loc: "San José, San José, Mata Redonda",
  ...
  },
  {
    ...
    loc: "Cartago, La Unión, Tres Ríos",
